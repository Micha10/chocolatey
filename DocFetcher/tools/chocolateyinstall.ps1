...
$url = 'http://sourceforge.net/projects/docfetcher/files/docfetcher/1.1.14/docfetcher_1.1.14_win32_setup.exe/download' # download url
$silentArgs = '/S' 
$validExitCodes = @(0) 
$toolsDir = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"

#Thanks to guillaumelachance(at)gmail.com for the correction
#the installer is primitive, and doesnt cover the possibility of either DocFetcher or the daemon being currently running
